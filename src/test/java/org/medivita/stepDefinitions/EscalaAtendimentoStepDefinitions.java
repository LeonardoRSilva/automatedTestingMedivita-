...
public class EscalaAtendimentoStepDefinitions {
	...
	@Given("^eu quero abrir menu esquerdo e selecionar item escala \"([^\"]*)\"$")
	public void eu_quero_abrir_menu_esquerdo_e_selecionar_item_escala(String arg1) throws Throwable {
